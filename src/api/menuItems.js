...
export const menuItemsApi = {
  ...
  toggleSpecial: (restaurantId, itemId) =>
    api.post(
      `/restaurants/${restaurantId}/menu-items/${itemId}/toggle-special`,
    ),
  toggleAvailable: (restaurantId, itemId) =>
    api.post(
      `/restaurants/${restaurantId}/menu-items/${itemId}/toggle-available`,
    ),
  // Search across all restaurants
  search: (query) => api.get("/menu-items/search", { params: { q: query } }),
};
